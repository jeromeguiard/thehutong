...
apt-get install postgreql postgresql-server-dev-9.1 libxml2 libxml2-dev libpq-dev python-gdal libgeoip1 -y 

mysql -pP0ww0w < sql_ini.sql 

#spatial libraries installation
apt-get install binutils libproj-dev gdal-bin bzip2 g++ make -y
